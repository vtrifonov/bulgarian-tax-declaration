...
describe('Excel Generator', () => {
  ...
  it('sales sheet has correct column headers', async () => {
    const state: AppState = {
      ...
      holdings: [],
      sales: [
        { id: '1', broker: 'IB', country: 'САЩ', symbol: 'MSFT', dateAcquired: '2023-01-10', dateSold: '2025-05-20', quantity: 2, currency: 'USD', buyPrice: 100, sellPrice: 250, fxRateBuy: 1.82, fxRateSell: 1.95 },
      ],
      dividends: [],
      stockYield: [],
      revolutInterest: [],
    ...
    const expectedHeaders = [
      'Брокер', 'Държава', 'Символ', 'Дата покупка', 'Дата продажба',
      'Кол.', 'Валута', 'Цена покупка', 'Цена продажба', 'Курс покупка',
      'Курс продажба', 'Приходи', 'Разходи', 'П/З'
    ];
